...
- [More](https://github.com/neticshard/postgresql-parser/network/dependents)
...
`goyacc` reads the SQL expressions ([`sql.y`](https://github.com/neticshard/postgresql-parser/blob/main/pkg/sql/parser/sql.y)) and generates a parser which could be used to tokenize a given input.
...
# Progress
- 2021-02-16 `github.com/neticshard/postgresql-parser/pkg/sql/parser` Unit tests works now!
- 2021-03-08 Add walker package.
- 2022-08-03 Remove vendored dependencies by @mostafa in https://github.com/neticshard/postgresql-parser/pull/19
